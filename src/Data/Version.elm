...
getRecord : Version -> { version : String, releasedAt : String, topic : String, url : String }
getRecord version =
    case version of
        V0_19_1 ->
            { version = "0.19.1"
            , releasedAt = "2019-10-21"
